...
const breedingAssociations = [
  {
    ...
    salesPortal: 'https://westfalenpferde.de/vermarktung/pferdemarkt/',
          ...
          <section id="kauftipps" className="scroll-mt-32 lg:scroll-mt-40 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-5">
                ...
                <p className="text-gray-600">
                  Auch bei einem netten Züchter im Münsterland gilt: Nur ein schriftlicher <LocalizedLink href="/pferde-ratgeber/pferdekaufvertrag" className="text-brand hover:text-brand-dark underline">Kaufvertrag</LocalizedLink> schützt dich rechtlich.
                </p>
              </div>
            </div>
          </section>
